    ...
    app.add(
        Grid().columns(3)
            .add(Card().compact().border("#4ec968")
                ...
                .add(Text("High contrast, modern aesthetic perfect for developer tools and dashboards.").muted())
            )
            .add(Card().compact().border("#40a9ff")
                .add(Text("Light Mode").h3())
                .add(Text("Clean, professional look ideal for documentation and marketing sites.").muted())
            )
